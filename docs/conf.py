...
# -*- coding: utf-8 -*-
#
# psychopy_tools documentation build configuration file, created by
...
release = psychopy_tools.__version__
...
htmlhelp_basename = 'psychopy_toolsdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'psychopy_tools.tex',
     u'Psychopy Tools Documentation',
